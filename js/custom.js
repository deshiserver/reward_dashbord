/*
Template: DeshiServer - Responsive Bootstrap 4 Admin Dashboard Template
Author: DeshiServer
...
(function (jQuery) {
    ...
    jQuery(document).ready(function () {
        ...
        Page faq
        -----------------------------------------------------------------------*/
        jQuery('.ds-accordion .ds-accordion-block .accordion-details').hide();
        jQuery('.ds-accordion .ds-accordion-block:first').addClass('accordion-active').children().slideDown('slow');
        jQuery(document).on("click", '.ds-accordion .ds-accordion-block', function () {
            if (jQuery(this).children('div.accordion-details ').is(':hidden')) {
                jQuery('.ds-accordion .ds-accordion-block').removeClass('accordion-active').children('div.accordion-details ').slideUp('slow');
       ...
       -----------------------------------------------------------------------*/
        ...
        jQuery(document).on('click', function (e) {
            ...
            if (jQuery(myTargetElement).hasClass('search-toggle') || jQuery(myTargetElement).parent().hasClass('search-toggle') || jQuery(myTargetElement).parent().parent().hasClass('search-toggle')) {
                ...
                if (!mainElement.hasClass('active') && jQuery(".navbar-list li").find('.active')) {
                    jQuery('.navbar-list li').removeClass('ds-show');
                    jQuery('.navbar-list li .search-toggle').removeClass('active');
                }

                selector.toggleClass('ds-show');
        ...
        Progress Bar
        -----------------------------------------------------------------------*/
        jQuery('.ds-progress-bar > span').each(function () {
        ...
        Mailbox
        -----------------------------------------------------------------------*/
        jQuery(document).on('click', 'ul.ds-email-sender-list li', function () {
        ...
        jQuery(document).on('click', '.ds-chat-ui li', function () {
            jQuery('.chat-data-left').removeClass('show');
        });
